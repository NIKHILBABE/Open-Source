...
for x in range(1000):
	rr = random.randint
	rc = random.choice
	A = f'Mozilla/5.0 (Linux; Android {str(rr(8,10))}; Nexus {str(rr(4,9))} Build/MOB30X)'
	B = f'{str(rr(111111,199999))}.011; en-us) AppleWebKit/537.36 '
	C = f'(KHTML, seperti Gecko) Chrome/59.0.3071.{str(rr(1111,9999))}.125 Safari/537.36'
	D = f'/537.36{str(rr(11111,99999))}AP'
	se = f'{A}{B}{C}{D}'
	if se in redmi:pass
